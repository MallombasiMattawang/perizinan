...
class VerificationTeknisController extends AdminController
{
    ...
    protected function form()
    {
        ...
        $form->tab('Rekomendasi Teknis', function ($form) {
            ...
            $form->file('doc_verified_teknis', 'Dokumen Rekomendasi Teknis')->rules('mimes:pdf')->move('rekomendasi_teknis')->help('Upload surat rekomendasi untuk permohonan ini');
        ...
        $form->saved(function ($form) {
            ...
            if ($form->status == 'VERIFIKASI TEKNIS BERHASIL') {
                return redirect('/admin-panel/historyTeknis');
            } else {
